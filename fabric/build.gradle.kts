...
dependencies {
    ...
    if (stonecutter.eval(mcVersion, ">1.21.1")) {
        modCompileOnly("maven.modrinth:farmers-delight-refabricated:${common.mod.dep("fd_fabric_version")}")
    }
    else if (stonecutter.eval(mcVersion, ">1.20")) {
        modCompileOnly("maven.modrinth:farmers-delight-refabricated:${common.mod.dep("fd_fabric_version")}")
    }
    else {
        modImplementation("maven.modrinth:farmers-delight-fabric:${common.mod.dep("fd_fabric_version")}")
    }
